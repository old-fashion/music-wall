        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player">' +
                        ...
                        '            <p class="album"><span class="album"></span></p>' +
                        '            <div class="rating">' +
            ...
            function setAlbum() {
                if (isUndefined(myPlaylist[current].album))
                    $album.parent(cssSelector.album).animate({opacity:0}, 'fast');
                else {
                    $album.html(myPlaylist[current].album).parent(cssSelector.album).animate({opacity:1}, 'fast');
                }
            }
